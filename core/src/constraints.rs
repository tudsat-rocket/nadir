...
pub struct ConstValue<V: Clone + Quantity> {
    value: V,
}

impl<V: Clone + Quantity> ConstValue<V> {
    pub fn new(value: V) -> Self {
        Self { value }
    }
}

impl<V: Clone + Quantity> ConstraintValue for ConstValue<V> {
    type Type = V;
...
pub trait ConstraintBuilder {
    ...
    fn eq_metric<M: MetricTrait<Quantity = <Self::Metric as MetricTrait>::Quantity>>()
    -> EqualsConstraint<Self::Metric, M> {
        EqualsConstraint {
            cached_metric: Self::Metric::default().cached(),
    ...
    fn leq_metric<M: MetricTrait<Quantity = <Self::Metric as MetricTrait>::Quantity>>()
    ...
    fn lt_metric<M: MetricTrait<Quantity = <Self::Metric as MetricTrait>::Quantity>>()
    -> LessThanConstraint<Self::Metric, M> {
        LessThanConstraint {
            cached_metric: Self::Metric::default().cached(),
            cached_constraint: M::default().cached(),
        }
    ...
    fn geq_metric<M: MetricTrait<Quantity = <Self::Metric as MetricTrait>::Quantity>>()
    ...
    fn gt_metric<M: MetricTrait<Quantity = <Self::Metric as MetricTrait>::Quantity>>()
    ...
    fn eq_const(
        value: <Self::Metric as MetricTrait>::Quantity,
    ) -> EqualsConstraint<Self::Metric, ConstValue<<Self::Metric as MetricTrait>::Quantity>>
    where
        <Self::Metric as MetricTrait>::Quantity: Clone,
    {
        EqualsConstraint {
            cached_metric: Self::Metric::default().cached(),
    ...
    fn leq_const(
        value: <Self::Metric as MetricTrait>::Quantity,
    ) -> LessOrEqualConstraint<Self::Metric, ConstValue<<Self::Metric as MetricTrait>::Quantity>>
    where
        <Self::Metric as MetricTrait>::Quantity: Clone,
    {
        LessOrEqualConstraint {
    ...
    fn lt_const(
        value: <Self::Metric as MetricTrait>::Quantity,
    ) -> LessThanConstraint<Self::Metric, ConstValue<<Self::Metric as MetricTrait>::Quantity>>
    where
        <Self::Metric as MetricTrait>::Quantity: Clone,
    {
        LessThanConstraint {
    ...
    fn geq_const(
        value: <Self::Metric as MetricTrait>::Quantity,
    ) -> GreaterOrEqualConstraint<Self::Metric, ConstValue<<Self::Metric as MetricTrait>::Quantity>>
    where
        <Self::Metric as MetricTrait>::Quantity: Clone,
    {
        GreaterOrEqualConstraint {
    ...
    fn gt_const(
        value: <Self::Metric as MetricTrait>::Quantity,
    ) -> GreaterThanConstraint<Self::Metric, ConstValue<<Self::Metric as MetricTrait>::Quantity>>
    where
        <Self::Metric as MetricTrait>::Quantity: Clone,
    {
        GreaterThanConstraint {
...
pub struct GreaterOrEqualConstraint<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> {
    cached_metric: CachedConstraintValue<M>,
    cached_constraint: CachedConstraintValue<C>,
}

impl<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> Constraint
    for GreaterOrEqualConstraint<M, C>
{
    type Metric = M;
...
pub struct GreaterThanConstraint<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> {
    cached_metric: CachedConstraintValue<M>,
    cached_constraint: CachedConstraintValue<C>,
}

impl<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> Constraint
    for GreaterThanConstraint<M, C>
{
    type Metric = M;
...
pub struct LessOrEqualConstraint<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> {
    cached_metric: CachedConstraintValue<M>,
    cached_constraint: CachedConstraintValue<C>,
}

impl<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> Constraint
    for LessOrEqualConstraint<M, C>
{
    type Metric = M;
...
pub struct LessThanConstraint<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> {
    cached_metric: CachedConstraintValue<M>,
    cached_constraint: CachedConstraintValue<C>,
}

impl<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> Constraint
    for LessThanConstraint<M, C>
{
    type Metric = M;
...
pub struct EqualsConstraint<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> {
    cached_metric: CachedConstraintValue<M>,
    cached_constraint: CachedConstraintValue<C>,
}

impl<M: MetricTrait, C: ConstraintValue<Type = M::Quantity>> Constraint for EqualsConstraint<M, C> {
    type Metric = M;
