use nadir_core::{System, mode_name_string};
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    let arm_button = if armed {
                        ...
                        // `Button::selectable` drops the frame while unselected, leaving an arm
                        // button with no boundary at all.
                    ...
                    for r in 0..rows {
                        ...
                        ui.columns(in_row, |columns| {
                            for (c, col_ui) in columns.iter_mut().enumerate().take(in_row) {
                                ...
                                // `Button::stroke` overrides the on-hover effects, and egui draws
                                // the focus ring as part of those. Paint them back.
